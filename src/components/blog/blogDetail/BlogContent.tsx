...
const BlogContent = ({ blog }: { blog: Blog }) => {
  return (
    <main className="mx-auto grid w-full max-w-307.5 grid-cols-1 gap-5 px-4 sm:grid-cols-[3fr_263px]! sm:px-7.5 lg:grid-cols-[3fr_341px]!">
      ...
      <section className="order-4 col-span-full overflow-hidden border-t border-t-[#E5E6EA] md:order-0 md:col-span-1 md:row-start-3 md:row-end-4 md:mb-16 md:border-t-0 [&_.swiper-slide]:w-full!">
        <BlogTestimonial />
      </section>
